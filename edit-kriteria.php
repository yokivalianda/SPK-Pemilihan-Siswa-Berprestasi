...
if(isset($_POST['submit'])){
	...
	// Validasi nama_kriteria Kriteria
	if(!$nama_kriteria) {
		$errors[] = 'nama_kriteria kriteria tidak boleh kosong';
	}		
	// Validasi Tipe
	if(!$type) {
	...
	if(empty($errors)){
		...
		$update = mysqli_query($koneksi,"UPDATE kriteria SET kode_kriteria = '$kode_kriteria', nama_kriteria = '$nama_kriteria', type = '$type', bobot = '$bobot', ada_pilihan = '$ada_pilihan' WHERE id_kriteria = '$id_kriteria'");
		...
		<div class="card-body">
			<div class="row">
				...
				<div class="form-group col-md-6">
					...
					<input autocomplete="off" type="text" name="nama_kriteria" required value="<?php echo $d['nama_kriteria']; ?>" class="form-control"/>
				</div>
