...
$alternatifs = array();
$q2 = mysqli_query($koneksi,"SELECT * FROM hasil_sortir JOIN siswa ON hasil_sortir.id_siswa=siswa.id_siswa ORDER BY hasil_sortir.nilai_hasil DESC");			
...
foreach($kriterias as $kriteria):
	foreach($alternatifs as $alternatif):
		...
		if($kriteria['ada_pilihan']==1){
			$q4 = mysqli_query($koneksi,"SELECT sub_kriteria.nilai_sub_kriteria FROM penilaian_akhir JOIN sub_kriteria WHERE penilaian_akhir.nilai_penilaian=sub_kriteria.id_sub_kriteria AND penilaian_akhir.id_siswa='$alternatif[id_siswa]' AND penilaian_akhir.id_kriteria='$kriteria[id_kriteria]'");
			$data = mysqli_fetch_array($q4);
			$nilai = $data['nilai_sub_kriteria'];
		}else{
			$q4 = mysqli_query($koneksi,"SELECT nilai_penilaian FROM penilaian_akhir WHERE id_siswa='$alternatif[id_siswa]' AND id_kriteria='$kriteria[id_kriteria]'");
			$data = mysqli_fetch_array($q4);
